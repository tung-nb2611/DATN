...
import addTtems from "../../views/Materials/addItems";
...
export default function ItemsTable(props) {
    ...
    function clickAddItems() {
        ...
        // setDescription('');
        // setIsActive('');
        props.history.push("admin/addItems");
    ...
    return (
        <div className={classes.tableResponsive}>
            <div className='FormAddItems' style={{display: 'none'}}>
            ...
            <div className='FormFixItems' style={{display: 'none'}}>
            ...
            <div className={classes.table}>
                ...
                <BrowserRouter>
                    <Link to="/admin/addItems">
                        <Button id='add'><AddIcon/></Button>
                        <Route path="/admin/addItems" component={DashboardPage} />
                    </Link>
                </BrowserRouter>
