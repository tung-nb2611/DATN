...
export default function CreateReceipt(props) {
  ...
  const addMaterial = (e) => {
    ...
    MaterialService.postMaterialDTO(material)
      .then(() => {
      ...
      <React.Fragment>
        <TableRow sx={{ "& > *": { borderBottom: "unset" } }}>
          ...
          <TableCell align="right">
            {showPrice(row.inputPrice).toString()} vnđ
          </TableCell>
          <TableCell align="right">
            <OutlinedInput
          ...
          <TableCell align="right">
            {row.inputPrice * row.quantityInput} vnđ
          </TableCell>
          <TableCell>
            <Clear
              onClick={() => deleteMaterialChoosed(row)}
              fontSize="small"
            />
          </TableCell>
        </TableRow>
                    ...
                    >
                      <table>
                        <tr>
                          ...
                          <td className="td-2">
                            {showPrice(materital.inputPrice).toString()}
                          </td>
                        </tr>
                        <tr>
                          <td className="td-1">{materital.code}</td>
                          <td className="td-2">
                            Số lượng trong kho: {materital.quantity}
                          </td>
                        </tr>
                      </table>
                    </div>
          ...
          <TableContainer component={Paper}>
            ...
            >
              ...
              <Typography variant="h6">
                {showPrice(sumMaterial).toString()}vnd
              </Typography>
            </Box>
          </TableContainer>
        </Box>
